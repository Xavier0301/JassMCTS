...
import ch.epfl.javass.ai.MctsRootParallelisationPlayer;
...
public class MctsRootParallelisationPlayerTest {
    ...
    void mctsPlayerPlaysCorrectly1() {
        ...
        MctsRootParallelisationPlayer p = new MctsRootParallelisationPlayer(PlayerId.PLAYER_2, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly2() {
        ...
        MctsRootParallelisationPlayer p = new MctsRootParallelisationPlayer(PlayerId.PLAYER_4, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly5() {
        ...
        MctsRootParallelisationPlayer p = new MctsRootParallelisationPlayer(PlayerId.PLAYER_3, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly6() {
        ...
        MctsRootParallelisationPlayer p = new MctsRootParallelisationPlayer(PlayerId.PLAYER_1, SEED, ITERATIONS, null);
        TurnState state = TurnState.initial(Color.SPADE, Score.INITIAL, PlayerId.PLAYER_1);
        CardSet hand = CardSet.EMPTY
    ...
    void mctsPlayerPlaysCorrectly9() {
        ...
        MctsRootParallelisationPlayer p = new MctsRootParallelisationPlayer(state.nextPlayer(), SEED, ITERATIONS, null);
        CardSet hand = CardSet.EMPTY
                .add(Card.of(Color.CLUB, Rank.SIX))
