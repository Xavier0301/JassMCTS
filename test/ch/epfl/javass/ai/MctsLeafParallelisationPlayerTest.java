...
public class MctsLeafParallelisationPlayerTest {
    ...
    void mctsPlayerPlaysCorrectly1() {
        ...
        MctsLeafParallelisationPlayer p = new MctsLeafParallelisationPlayer(PlayerId.PLAYER_2, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly2() {
        ...
        MctsLeafParallelisationPlayer p = new MctsLeafParallelisationPlayer(PlayerId.PLAYER_4, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly5() {
        ...
        MctsLeafParallelisationPlayer p = new MctsLeafParallelisationPlayer(PlayerId.PLAYER_3, SEED, ITERATIONS, null);
    ...
    void mctsPlayerPlaysCorrectly6() {
        ...
        MctsLeafParallelisationPlayer p = new MctsLeafParallelisationPlayer(PlayerId.PLAYER_1, SEED, ITERATIONS, null);
        TurnState state = TurnState.initial(Color.SPADE, Score.INITIAL, PlayerId.PLAYER_1);
        CardSet hand = CardSet.EMPTY
    ...
    void mctsPlayerPlaysCorrectly9() {
        ...
        MctsLeafParallelisationPlayer p = new MctsLeafParallelisationPlayer(state.nextPlayer(), SEED, ITERATIONS, null);
        CardSet hand = CardSet.EMPTY
                .add(Card.of(Color.CLUB, Rank.SIX))
